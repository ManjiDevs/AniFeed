...
export async function fetchNormalizedFeed({ limit } = {}) {
  ...
  // AnimeSalt.cx serves its current "Fresh Drops" listing directly on the
  // homepage. Do not probe old .to endpoints such as /new-release because
  // they do not exist on the current site.
